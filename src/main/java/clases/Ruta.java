...
public class Ruta {
    ...
    private Estado estado_ruta;
    private String color;

    //Getters, Setters y Constructor
    public Ruta(int id_ruta, int sucursal_origen, int sucursal_destino, int tiempo_de_transito, float capacidad_maxima, Estado estado_ruta, String color) {
    ...
    public Estado getEstado_ruta() {
        return estado_ruta;
    }

    public void setEstado_ruta(Estado estado_ruta) {
        this.estado_ruta = estado_ruta;
    }
