...
public class Sucursal {
    ...
    private Estado estado_sucursal;

    //Getters, Setters y Constructor
    public Sucursal(int id_sucursal, String nombre, String horario_apertura, String horario_cierre, Estado estado_sucursal) {
    ...
    public Estado getEstado_sucursal() {
        return estado_sucursal;
    }

    public void setEstado_sucursal(Estado estado_sucursal) {
        this.estado_sucursal = estado_sucursal;
    }
